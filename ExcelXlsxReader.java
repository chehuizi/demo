package com.alibaba.crm.authcenter.biz.common.util;
...
public abstract class ExcelXlsxReader extends DefaultHandler {
	...
	public static void main(String[] args) {
		try {
			String file = "/Users/chehuizi/Desktop/阿里巴巴数据表（降序）.xlsx";
			ExcelXlsxReader reader = new ExcelXlsxReader() {

				@Override
				public void getRows(int sheetIndex, int curRow, List<String> rowList) {
					if (rowList.size() == 12 && StringUtils.isNotBlank(rowList.get(11))) {
						System.out.println("Sheet:" + sheetIndex + ", Row:" + curRow + ", DataSize:" + rowList.size()
								+ ", Data" + rowList.subList(7, rowList.size()));
					}
				}
