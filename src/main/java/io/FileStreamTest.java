...
public class FileStreamTest {
	 ...
	 *
	 * 加入，我们将 FileOutputStream fileOut2 = new FileOutputStream(file, true); 修改为
	 * FileOutputStream fileOut2 = new FileOutputStream(file, false);
	 * 然后再执行程序，“file.txt”的内容变成"0123456789"。 原因是： (01) FileOutputStream fileOut2
	 * = new FileOutputStream(file, true); 它是以“追加模式”将内容写入文件的。即写入的内容，追加到原始的内容之后。
